...
const questions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'party', label: 'Cocktail Party', icon: '🎉', value: 'party' },
...
const cocktailResults: Record<string, CocktailResult> = {
  ...
  'party-fresh-cold-classic': {
    ...
    occasion: 'Hosting & entertaining',
  },
  'party-spicy-cold-craft': {
    name: 'Spiced Gold Rush',
    brand: 'redemption',
    spirit: 'Redemption Bourbon',
    description: 'A twist on the classic with warming ginger. Perfect for gatherings and entertaining.',
  ...
  'dinner-smoky-neat-craft': {
    ...
    brand: 'bib',
    spirit: 'Bib & Tucker Classic Six',
    description: 'Complex and sophisticated. Port wine adds depth while allspice brings warming spice.',
